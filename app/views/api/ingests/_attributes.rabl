...
attributes :id, :upload_id, :document_id, :type, :status,
  ...
  :removed_at, :finished_at, :progress, :messages, :stage, :stages, :iteration, :busy, :terminate, :uid, :locale, :events,
  :source_url, :file_name, :file_type, :file_size, :metadata,
  :use_source_annotations, :handle, :origin_url
