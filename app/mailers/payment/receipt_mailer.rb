class Payment::ReceiptMailer < ApplicationMailer
  add_template_helper Web::ApplicationHelper
  helper Payola::PriceHelper

  default from: Payola.support_email
    ...
    ActiveRecord::Base.connection_pool.with_connection do
      ...
      if Payola.pdf_receipt
        ...
        pdf = Docverter::Conversion.run do |c|
          c.from = 'html'
          c.to = 'pdf'
          c.content = render_to_string('payment/receipt_mailer/receipt_pdf.html')
        end
      ...
      mail_params = {
        ...
        subject: @product.respond_to?(:receipt_subject) ? @product.receipt_subject(@sale) : 'Payment receipt'
      }
