...
VZ._social = (function() {
  ...
  var bind = function bind() {
    ...
    $('.social-networks .twitter a').on('click', function(e) {
      ...
      href = 'https://twitter.com/intent/tweet?related=' + 'voyzes' + '&url=' + encodeURIComponent(tw_url) + '&text=' + encodeURIComponent(VZ.config.twitter.prefix) + '&hashtags=' + encodeURIComponent(VZ.config.twitter.hashtags);
