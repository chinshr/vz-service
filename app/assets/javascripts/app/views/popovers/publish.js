App.Views.PopoversPublish = App.Views.PopoverBase.extend({
  template: JST['popovers/publish'],
  ...
  render: function() {
    this.holder = this.holder || $('#publish-button');
          ...
          return _this.model.sync('update', _this.model, {
            success: (function(_this) {
              return function() {
                ...
                if (_this.callbacks && _this.callbacks.privacy && _this.callbacks.privacy.success) {
                  _this.callbacks.privacy.success();
                }
              };
            })(_this),
            error: (function(_this) {
              return function() {
                if (_this.callbacks && _this.callbacks.privacy && _this.callbacks.privacy.error) {
                  _this.callbacks.privacy.error();
                }
              };
            })(_this)
          });
