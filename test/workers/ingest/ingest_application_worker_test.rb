...
class Ingest::MediaIngest::FooWorker < Ingest::IngestApplicationWorker; end

class Ingest::IngestApplicationWorkerTest < ActiveSupport::TestCase

  context "class" do
    setup do
      Ingest::IngestApplicationWorker.queues = {}
    end
