module Api::Code
  ...
  @@error_codes = {
    ...
    '-6'  => {:http => 403, :message => 'api.error_code.saml_error'},
    '-7'  => {:http => 422, :message => 'api.error_code.argument_unsupported'},
    '-8'  => {:http => 422, :message => 'api.error_code.ownership_invalid'},
    '-9'  => {:http => 422, :message => 'api.error_code.invoice_invalid'},
    '-10' => {:http => 400, :message => 'api.error_code.invalid_utf8'},
    '-11' => {:http => 400, :message => 'api.error_code.argument_invalid'},
    '-12' => {:http => 401, :message => 'api.error_code.invalid_region'},
    '-13' => {:http => 422, :message => 'api.error_code.deletion_error'},
    '-14' => {:http => 400, :message => 'api.error_code.oauth2.error'},
    '-15' => {:http => 400, :message => 'api.error_code.billing_error'},
    '-16' => {:http => 400, :message => 'api.error_code.invalid_state_transition'},
    '-17' => {:http => 403, :message => 'api.error_code.device_limit'},
    '-18' => {:http => 400, :message => 'api.error_code.format_unsupported'},
    '-19' => {:http => 400, :message => 'api.error_code.action_unsupported'},
    '-20' => {:http => 400, :message => 'api.error_code.batch_limit'},
    '-21' => {:http => 400, :message => 'api.error_code.mismatch_format'},
    '-22' => {:http => 403, :message => 'api.error_code.device_limit_period'},
